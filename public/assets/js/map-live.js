// map-live.js
// Standalone script to render static locations list + live updates from MQTT.
// Usage:
//  - ensure `const locations = [...]` exists on the page BEFORE including this script
//  - include <script src="../assets/js/map-live.js"></script> after map + markers created
//  - optionally set window.CLIMBOX_MAP_CONFIG before including to override MQTT_WS etc.
//
// Example override (optional, put BEFORE this script):
